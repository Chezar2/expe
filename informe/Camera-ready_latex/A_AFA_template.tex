...
hay que tener en cuenta que el texto se reproduce a tamaño real, sin reducción ni ampliación, por lo que el formato de página y los estilos de texto deben ser respetados.
...
Todo manuscrito debe tener espaciado simple, incrementándolo automáticamente para subíndices y supraíndices. Debe usarse fuente Times New Roman y generarse en dos columnas. Se ahorran todos estos ajustes al usar este temggggggggggggggggggplate en \LaTeX.
