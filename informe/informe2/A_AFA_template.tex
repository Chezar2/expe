...
En este trabajo se analiza la curva característica de un diodo conectado en serie con resistencias.
 Mediante un ajuste no lineal, utilizando la ecuación de Shockley, se determinó la corriente de saturación $I_S=(1,0\pm0,1)\times10^{-8}A$ y el coeficiente $\eta=(1,71\pm0,01)$ , confirmando 
...
Donde $I_S$ es la corriente de saturación, $\eta$ es el coeficiente de emisión, que depende del material con que esta fabricado el componente, y $V_T$ es la tensión equivalente de temperatura,
que cumple:
\begin{equation}V_T = kT/q\end{equation}
 ...
 %
    \begin{figure}[ht]
    \centering
    \includegraphics[width=0.35\textwidth]{circuito1.png} %las imagenes van en pdf
  \caption{Esquema de circuito de polarizacion directa de un diodo ($D$) con resistencia ($R$) en serie, conectado a una fuente de voltaje ($V_{CC}$).}
  \label{fig:figura1}
  \end{figure}
%
...
De modo que se puede escribir la corriente $I_D$ en función de la tensión $V_D$:
...
definiendo al conjunto de puntos $(I_D,V_D)$ que cumplen ambas ecuaciones, como puntos de trabajo o puntos Q. Por lo tanto, variando el voltaje de la fuente $V_{CC}$
 ...
 \begin{figure}[ht]
    \centering
    \includegraphics[width=0.45\textwidth]{curva-recta.png}
...
\section{METODOLOGÍA}
  ...
  %%
    \begin{figure}[ht]
    \centering
    \includegraphics[width=0.3\textwidth]{circuito2.png} %las imagenes van en pdf 
...
poder medir la curva característica en un amplio rango de voltajes y corrientes.


Luego se arma el circuito de la figura(2) con los elementos dados, y se conecta a la fuente de voltaje, estableciendo con las perillas de ajuste la corriente máxima y voltaje $0V$.
...
%
  ...
  %
   \begin{figure}[ht]
    \centering
    \includegraphics[width=0.4\textwidth]{residuo.png} 
