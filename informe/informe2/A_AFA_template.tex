...
, el análisis de los residuos del ajuste indica que el modelo ideal no describe completamente el comportamiento del diodo, sugiriendo la necesidad de considerar factores adicionales para mejorar el ajuste.
